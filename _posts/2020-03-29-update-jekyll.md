...
installing ffi failed and that the following has to be fixed.
```
...
I think this is because the macOS ruby and the homebrew ones
are different. It was fixed with:
```
