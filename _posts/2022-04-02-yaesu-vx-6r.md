...
The VX-6R is what I bring on the boat (as it is waterproof), and when
I'm carrying a HT around to speak on the [MWRS repeater](https://www.mwrs.org.au/mwrs-landing/vk2rmb-repeater-systems/). 

The only thing I don't like about the radio is the menu system is overly 
complicated. I need to refer to the manual to program the radio 
from the keyboard and to do many other things.
